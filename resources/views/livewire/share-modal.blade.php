<div>
    {{-- Modal Component --}}
    <flux:modal name="share-modal-{{ $logoGeneration->id }}" wire:model="showModal" class="w-[90%] max-w-md sm:max-w-2xl lg:!max-w-5xl">
            ...
            @if(!$shareUrl)
                ...
                <form wire:submit="createShare" class="space-y-6">
                    ...
                    <flux:field>
                        ...
                        <flux:input
                            wire:model="title"
                            placeholder="{{ $logoGeneration->business_name }}"
                            :disabled="$isLoading"
                        />
                    ...
                    <flux:field>
                        ...
                        <flux:textarea
                            ...
                            placeholder="Add a description to your shared project..."
                            rows="3"
                            :disabled="$isLoading"
                        />
                    ...
                    {{-- Privacy Settings --}}
                    <div class="space-y-4">
                        <flux:heading size="sm">Privacy Settings</flux:heading>

                        {{-- Share Type Selection --}}
                        <flux:field>
                            <flux:label>Share Type</flux:label>
                            <flux:select wire:model.live="shareType" :disabled="$isLoading">
                        ...
                        {{-- Password Field (shown only for password-protected) --}}
                        ...
                        <flux:field>
                            ...
                            <flux:select wire:model="expiresInDays" :disabled="$isLoading">
                    ...
                    <div class="flex justify-end gap-2">
                        <flux:modal.close>
                            <flux:button variant="ghost" :disabled="$isLoading">
                                Cancel
                            </flux:button>
                        </flux:modal.close>

                        <flux:button type="submit" variant="primary" :disabled="$isLoading">
                            <span wire:loading.remove wire:target="createShare">Create Share Link</span>
                            <span wire:loading wire:target="createShare">Creating...</span>
                        </flux:button>
                    </div>
                </form>
            @else
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-5 gap-3">
                            ...
                            >
                                ...
                                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">X</span>
                            </a>
                            ...
                            >
                                ...
                                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">LinkedIn</span>
                            </a>
                            ...
                            >
                                ...
                                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">Facebook</span>
                            </a>

                            {{-- Reddit --}}
                            <a
                                href="{{ $socialMediaUrls['reddit'] ?? '#' }}"
                                target="_blank"
                                rel="noopener noreferrer"
                                class="flex flex-col items-center gap-2 p-3 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                            >
                                ...
                                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">Reddit</span>
                            </a>
                            ...
                            >
                                ...
                                <span class="text-xs font-medium text-gray-600 dark:text-gray-400">WhatsApp</span>
                            </a>
                        </div>
                    </div>
