                ...
                <div class="flex items-center justify-between mb-3">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        @elseif($this->hasGeneratedLogos && $this->logoGenerationId)
                            <!-- Completed - status indicator (button is shown in the banner below) -->
                ...
                <div x-show="hasLogos" x-cloak>
                    ...
                    <div x-show="!generatingLogos && logos.length === 4" class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 mb-4">
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <a
                                x-bind:href="`/logo-gallery/${logoGenerationId}`"
                                class="inline-flex items-center gap-2 px-4 py-2 text-base font-bold text-white bg-gray-900 hover:bg-gray-800 dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100 rounded-lg transition-all shadow-lg hover:shadow-xl hover:scale-105 whitespace-nowrap border-2 border-gray-900 dark:border-white"
                            >
