<div>
    <flux:header class="mb-8">
        <flux:heading size="xl" class="!mb-8">Domain Checker</flux:heading>
        <flux:subheading class="!mt-2">Quickly check domain availability for your business name ideas</flux:subheading>
    </flux:header>
