...
<div class="relative group mb-2 animate-pulse">
    <div class="p-3 rounded-lg border border-transparent bg-zinc-50 dark:bg-zinc-800/50">
        <!-- Session Header -->
        <div class="flex items-start justify-between mb-2">
            <div class="flex-1 min-w-0 pr-2">
                <!-- Title Skeleton -->
                <div class="h-4 bg-zinc-200 dark:bg-zinc-700 rounded w-3/4 mb-1"></div>
            </div>
