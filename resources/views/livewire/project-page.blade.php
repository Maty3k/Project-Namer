<div class="w-full max-w-full mx-auto p-1
    ...
    <div class="rounded-lg shadow-lg themed-project-box p-2
                                    ...
                                    <flux:field>
                                        <div class="flex items-center gap-1.5
                                            ...
                                            <flux:checkbox
                                                ...
                                                id="gpt4"
                                            />
                                            <flux:label for="gpt4" class="text-xs
                                                                          sm:text-sm">GPT-4o</flux:label>
                                        </div>
                                    </flux:field>
                                    <flux:field>
                                        <div class="flex items-center gap-1.5
                                            ...
                                            <flux:checkbox
                                                ...
                                                id="claude"
                                            />
                                            <flux:label for="claude" class="text-xs
                                                                            sm:text-sm">Claude 3.5</flux:label>
                                        </div>
                                    </flux:field>
                                    <flux:field>
                                        <div class="flex items-center gap-1.5
                                            ...
                                            <flux:checkbox
                                                ...
                                                id="gemini"
                                            />
                                            <flux:label for="gemini" class="text-xs
                                                                            sm:text-sm">Gemini Pro</flux:label>
                                        </div>
                                    </flux:field>
                                    <flux:field>
                                        <div class="flex items-center gap-1.5
                                            ...
                                            <flux:checkbox
                                                ...
                                                id="grok"
                                            />
                                            <flux:label for="grok" class="text-xs
                                                                          sm:text-sm">Grok</flux:label>
                                        </div>
                                    </flux:field>
                                </div>
        ...
        <!-- AI Generation History Section - Only shown when AI generations exist -->
        @if(!empty($aiGenerationHistory) && $aiGenerationHistory->isNotEmpty())
