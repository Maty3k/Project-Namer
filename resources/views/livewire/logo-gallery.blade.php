        ...
        <flux:modal wire:model="showDeleteAllModal" class="min-w-96">
            <div class="space-y-6">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        Are you sure you want to delete all {{ $logos->count() }} logos? This action cannot be undone.
                    </p>
                        ...
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                <p class="text-sm font-medium text-red-800 dark:text-red-200">
                                    Warning: This will permanently delete all logo files
                                </p>
                                <p class="mt-1 text-xs text-red-700 dark:text-red-300">
                                    All {{ $logos->count() }} logos will be removed from storage and cannot be recovered.
                                </p>
                            </div>
                        </div>
                    </div>
