...
describe('Session Manager', function (): void {
    it('can create a new generation session', function (): void {
        ...
        expect($session->requested_models)->toBe(['gpt-4o', 'claude-3-5-sonnet-20241022']);
    ...
    it('can retrieve full session details', function (): void {
        ...
        expect($details['requested_models'])->toBe(['gpt-4o', 'claude-3-5-sonnet-20241022']);
    });
    ...
    it('can retrieve active sessions', function (): void {
        ...
        $activeSession2 = $this->service->startSession('Platform 2', ['claude-3-5-sonnet-20241022'], 'professional');
    ...
    it('can retrieve recent session history', function (): void {
        ...
        $session2 = $this->service->startSession('Recent Platform 2', ['claude-3-5-sonnet-20241022'], 'professional');
    ...
    it('can generate session statistics', function (): void {
        ...
        $completedSession = $this->service->startSession('Stats Platform 2', ['claude-3-5-sonnet-20241022'], 'professional');
        $completedSession->markAsCompleted(['test' => 'results']);
