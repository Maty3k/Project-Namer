                    ...
                    <div x-show="!generatingLogos && logos.length === 4" class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3 mb-4">
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <a
                                ...
                                class="inline-flex items-center gap-1.5 px-3 py-1.5 text-sm font-medium text-white bg-green-600 hover:bg-green-700 dark:bg-green-500 dark:hover:bg-green-600 rounded-lg transition-colors shadow-sm hover:shadow-md whitespace-nowrap"
                            >
