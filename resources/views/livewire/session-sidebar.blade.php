                    ...
                    >
                        ...
                        >
                            ...
                            <div class="flex items-center justify-between text-xs text-gray-400 dark:text-gray-500">
                                ...
                                <div class="flex items-center gap-2">
                                    @php
                                        $favoritesCount = $session->getFavoritedNamesCount();
                                    @endphp
                                    @if($favoritesCount > 0)
                                        <div class="flex items-center gap-1 text-yellow-500 dark:text-yellow-400" title="{{ $favoritesCount }} favorited {{ Str::plural('name', $favoritesCount) }}">
