            ...
            <div class="flex items-center space-x-3">
                ...
                @if($this->hasDomains && $this->totalDomainsCount > 0)
                    <div class="flex items-center px-2 py-1 rounded-full {{ $this->availableDomainsCount > 0 ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30' }}"
                        ...
                        <span class="ml-1 text-xs font-medium {{ $this->availableDomainsCount > 0 ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}">
                            {{ $this->availableDomainsCount }}/{{ $this->totalDomainsCount }}
                        </span>
                    </div>
                @endif
