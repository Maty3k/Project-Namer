                                ...
                                @if(!$collapsed)
                                    <div class="flex items-start gap-3 group-hover:pr-8 transition-all duration-200">
                                        ...
                                        <div class="flex-shrink-0 ml-2 flex items-center transition-all duration-300 ease-out delay-100">
                                            @if($this->isActiveProject($project) && !$bulkDeleteMode)
                                            ...
                                            @if($bulkDeleteMode)
                                                <!-- Selected Arrow Indicator in Bulk Delete Mode -->
                                                <svg class="w-5 h-5 transition-all duration-200 ease-out {{ in_array($project->uuid, $selectedProjects) ? 'opacity-100 scale-100' : 'opacity-0 scale-50' }} {{ $userTheme ? 'theme-icon' : 'text-blue-600 dark:text-blue-400' }}"
                                                     fill="none" stroke="currentColor" viewBox="0 0 24 24">
