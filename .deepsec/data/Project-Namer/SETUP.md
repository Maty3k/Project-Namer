# Agent setup for `Project-Namer`

This is a deepsec scanning workspace. Project `Project-Namer` was just registered
(target: `..`). Setup is incomplete — `data/Project-Namer/INFO.md`
...
2. **Fill in `data/Project-Namer/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id Project-Namer
pnpm deepsec process --project-id Project-Namer
```
